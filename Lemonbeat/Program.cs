...
namespace Lemonbeat
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            CoreLogic.RegisterationOfModelServicesPair(new VideoLesson().GetType().GUID, new List<Type> { new VideoLessonService().GetType() });
            CoreLogic.RegisterationOfModelServicesPair(new Person().GetType().GUID, new List<Type> { new MembershipService().GetType() });
